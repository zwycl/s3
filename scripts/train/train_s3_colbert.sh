...
# export BASE_MODEL='Qwen/Qwen2.5-7B-Instruct'
export EXPERIMENT_NAME="s3_8_3_colbert_${RANDOM_SEED}"
export VLLM_ATTENTION_BACKEND=XFORMERS

PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    data.train_files=$DATA_DIR/train_e5_s3.parquet \
    data.val_files=$DATA_DIR/test_e5_s3.parquet \
    data.train_data_num=500 \
    data.val_data_num=21 \
    data.train_batch_size=21 \
    data.val_batch_size=21 \
    ...
    +output_context_dir="data/output_sequences_s3_8_3_colbert" \
